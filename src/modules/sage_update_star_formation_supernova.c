/**
 * @file    sage_update_star_formation_supernova.c
 * @brief   SAGE star formation and supernova feedback update module
 *
...
int sage_update_star_formation_supernova_init(void)
{
    ...
    INFO_LOG("SAGE update star formation and supernova module initialized");
...
int sage_update_star_formation_supernova_cleanup(void)
{

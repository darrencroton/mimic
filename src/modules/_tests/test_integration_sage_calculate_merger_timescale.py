...
This test validates that the sage_calculate_merger_timescale module correctly
...
def test_module_loads():
    """
    Test that sage_calculate_merger_timescale module loads and initializes successfully
    ...
    param_file, output_dir, test_temp_dir = create_test_param_file(
        output_name="sage_calculate_merger_timescale_load",
        phase_config={
            'pre_timestep': [],
            'phase_1': [('sage_calculate_merger_timescale', 'process_full_halo')],
            'phase_2': [],
            'post_timestep': []
        },
        model_params={}
    ...
    assert "SAGE calculate merger timescale initialized" in stdout, \
        f"sage_calculate_merger_timescale should log initialization message\nStdout:\n{stdout}"
...
def test_memory_safety():
    """
    Test that sage_calculate_merger_timescale doesn't leak memory
    ...
    # ===== SETUP =====
    param_file, output_dir, test_temp_dir = create_test_param_file(
        output_name="sage_calculate_merger_timescale_memory",
        phase_config={
            'pre_timestep': [],
            'phase_1': [('sage_calculate_merger_timescale', 'process_full_halo')],
            'phase_2': [],
...
def test_output_properties_exist():
    ...
    # ===== SETUP =====
    param_file, output_dir, test_temp_dir = create_test_param_file(
        output_name="sage_calculate_merger_timescale_properties",
...
def test_output_property_types():
    ...
    # ===== SETUP =====
    param_file, output_dir, test_temp_dir = create_test_param_file(
        output_name="sage_calculate_merger_timescale_types",
        output_format="binary",
        phase_config={
            'pre_timestep': [],
            'phase_1': [('sage_calculate_merger_timescale', 'process_full_halo')],
...
def test_output_sanity_checks():
    ...
    # ===== SETUP =====
    param_file, output_dir, test_temp_dir = create_test_param_file(
        output_name="sage_calculate_merger_timescale_sanity",
        output_format="binary",
        phase_config={
            'pre_timestep': [],
            'phase_1': [('sage_calculate_merger_timescale', 'process_full_halo')],
...
def test_data_flow_validation():
    ...
    # ===== SETUP =====
    param_file, output_dir, test_temp_dir = create_test_param_file(
        output_name="sage_calculate_merger_timescale_dataflow",
        output_format="binary",
        phase_config={
            'pre_timestep': [],
            'phase_1': [('sage_calculate_merger_timescale', 'process_full_halo')],
...
def test_standalone_execution():
    """
    Test that sage_calculate_merger_timescale runs standalone without dependencies
    ...
    # ===== SETUP =====
    param_file, output_dir, test_temp_dir = create_test_param_file(
        output_name="sage_calculate_merger_timescale_standalone",
        phase_config={
            'pre_timestep': [],
            'phase_1': [('sage_calculate_merger_timescale', 'process_full_halo')],
            'phase_2': [],
...
def test_with_infall_module():
    ...
    param_file, output_dir, test_temp_dir = create_test_param_file(
        output_name="sage_calculate_merger_timescale_infall",
        output_format="binary",
        phase_config={

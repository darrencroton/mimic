...
This test validates software quality aspects of the sage_prepare_infall_budget module:
...
def test_module_loads():
    """
    Test that sage_prepare_infall_budget module loads and initializes successfully
...
def test_output_properties_exist():
    ...
    Expected: HotGas, MetalsHotGas, EjectedGas, and ICS in output file
...
def test_with_satellite_stripping():
    """
    Test that sage_prepare_infall_budget works with sage_satellite_stripping module
...
def test_memory_safety():
    """
    Test that sage_prepare_infall_budget doesn't leak memory
...
def test_multiple_module_pipeline():
    """
    Test that sage_prepare_infall_budget works with other modules in pipeline

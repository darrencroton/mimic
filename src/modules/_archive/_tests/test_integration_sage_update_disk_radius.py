...
This test validates the sage_update_disk_radius module integration:
...
def test_module_pipeline_integration():
    ...
    param_file, output_dir, temp_dir = create_test_param_file(
        ...
        phase_config={
            'pre_timestep': [('sage_update_disk_radius', 'process_full_halo')],
            'phase_1': [],
            'phase_2': [],
            'post_timestep': []
        },
...
def main():
    """Main test runner"""
    print(f"{BLUE}{'=' * 60}{NC}")
    print(f"{BLUE}Test Suite: sage_update_disk_radius Integration Tests{NC}")
    print(f"{BLUE}{'=' * 60}{NC}")

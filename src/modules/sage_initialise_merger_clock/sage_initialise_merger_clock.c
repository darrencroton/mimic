 ...
 * @brief   SAGE merger clock initialisation - assigns merger timescales, handles Type 0 reset and Type 2 force-merge
 *
...
int sage_initialise_merger_clock_process(struct ModuleContext *ctx,
                                             struct Halo *halos,
                                             int ngal)
{

...
This test validates software quality aspects of the sage_add_cooling module:
...
NOTE: sage_add_cooling requires sage_calculate_cooling (phase_1) to calculate CoolingGas
...
def test_module_loads():
    """
    Test that sage_add_cooling module loads and initializes successfully
    ...
    param_file, output_dir, temp_dir = create_test_param_file(
        output_name="sage_add_cooling_load",
        phase_config={
            'pre_timestep': [('sage_reionization', 'process_full_halo'), ('sage_calculate_infall', 'process_full_halo')],
            'phase_1': [('sage_add_infall', 'process_full_halo'), ('sage_calculate_cooling', 'process_by_galaxy'), ('sage_add_cooling', 'process_by_galaxy')],
            'phase_2': [],
            'post_timestep': []
        },
...
def test_output_properties_exist():
    ...
    # ===== SETUP =====
    param_file, output_dir, temp_dir = create_test_param_file(
        output_name="sage_add_cooling_output",
        phase_config={
            'pre_timestep': [('sage_reionization', 'process_full_halo'), ('sage_calculate_infall', 'process_full_halo')],
            'phase_1': [('sage_add_infall', 'process_full_halo'), ('sage_calculate_cooling', 'process_by_galaxy'), ('sage_add_cooling', 'process_by_galaxy')],
            'phase_2': [],
...
def test_with_sage_calculate_cooling():
    """
    Test that sage_add_cooling works with sage_calculate_cooling module

    Expected: Both modules execute successfully together
    Validates: sage_add_cooling requires sage_calculate_cooling to set CoolingGas
    """
    print("Testing with sage_calculate_cooling...")

    # ===== SETUP =====
    param_file, output_dir, temp_dir = create_test_param_file(
        output_name="sage_add_cooling_with_calc",
        phase_config={
            'pre_timestep': [('sage_reionization', 'process_full_halo'), ('sage_calculate_infall', 'process_full_halo')],
            'phase_1': [('sage_add_infall', 'process_full_halo'), ('sage_calculate_cooling', 'process_by_galaxy'), ('sage_add_cooling', 'process_by_galaxy')],
            'phase_2': [],
    ...
    assert "SAGE add cooling module initialized" in stdout, \
        "sage_add_cooling should initialize"
...
def test_memory_safety():
    """
    Test that sage_add_cooling doesn't leak memory
    ...
    # ===== SETUP =====
    param_file, output_dir, temp_dir = create_test_param_file(
        output_name="sage_add_cooling_memory",
        phase_config={
            'pre_timestep': [('sage_reionization', 'process_full_halo'), ('sage_calculate_infall', 'process_full_halo')],
            'phase_1': [('sage_add_infall', 'process_full_halo'), ('sage_calculate_cooling', 'process_by_galaxy'), ('sage_add_cooling', 'process_by_galaxy')],
            'phase_2': [],
...
def test_execution_completes():
    ...
    # ===== SETUP =====
    param_file, output_dir, temp_dir = create_test_param_file(
        output_name="sage_add_cooling_complete",
        phase_config={
            'pre_timestep': [('sage_reionization', 'process_full_halo'), ('sage_calculate_infall', 'process_full_halo')],
            'phase_1': [('sage_add_infall', 'process_full_halo'), ('sage_calculate_cooling', 'process_by_galaxy'), ('sage_add_cooling', 'process_by_galaxy')],
            'phase_2': [],
...
def test_gas_transfer_physics():
    ...
    # ===== SETUP =====
    param_file, output_dir, temp_dir = create_test_param_file(
        output_name="sage_add_cooling_transfer",
        phase_config={
            'pre_timestep': [('sage_reionization', 'process_full_halo'), ('sage_calculate_infall', 'process_full_halo')],
            'phase_1': [('sage_add_infall', 'process_full_halo'), ('sage_calculate_cooling', 'process_by_galaxy'), ('sage_add_cooling', 'process_by_galaxy')],
            'phase_2': [],
...
def test_metallicity_preservation():
    ...
    # ===== SETUP =====
    param_file, output_dir, temp_dir = create_test_param_file(
        output_name="sage_add_cooling_metallicity",
        phase_config={
            'pre_timestep': [('sage_reionization', 'process_full_halo'), ('sage_calculate_infall', 'process_full_halo')],
            'phase_1': [('sage_add_infall', 'process_full_halo'), ('sage_calculate_cooling', 'process_by_galaxy'), ('sage_add_cooling', 'process_by_galaxy')],
            'phase_2': [],
...
def test_cooling_energy_tracking():
    ...
    # ===== SETUP =====
    param_file, output_dir, temp_dir = create_test_param_file(
        output_name="sage_add_cooling_energy",
        phase_config={
            'pre_timestep': [('sage_reionization', 'process_full_halo'), ('sage_calculate_infall', 'process_full_halo')],
            'phase_1': [('sage_add_infall', 'process_full_halo'), ('sage_calculate_cooling', 'process_by_galaxy'), ('sage_add_cooling', 'process_by_galaxy')],
            'phase_2': [],

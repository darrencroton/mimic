...
#define DEFAULT_MAX_DYNAMIC_SUBSTEPS 200 /* Default ceiling for dynamic timestep substeps */
...
#define HORIZONTAL_OUTPUT_SEED_HEADROOM 0.05 /* Horizontal output seed = slab + this fraction */

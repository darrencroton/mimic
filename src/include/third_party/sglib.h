...
#define SGLIB___ARRAY_HEAP_DOWN(type, a, ind, max, comparator, elem_exchanger)                     \
  {                                                                                                \
    ...
    do {                                                                                           \
      ...
      _r_ = _l_ + 1;                                                                               \
      if (_l_ < (max)) {                                                                           \
        if (comparator(((a)[_m_]), ((a)[_l_])) < 0)                                                \
          _m_ = _l_;                                                                               \
        if (_r_ < (max)) {                                                                         \
          if (comparator(((a)[_m_]), ((a)[_r_])) < 0)                                              \
            _m_ = _r_;                                                                             \
        }                                                                                          \
      }                                                                                            \
      if (_m_ != _i_) {                                                                            \
...
#define SGLIB___ARRAY_HEAP_DOWN_MULTICOMP(type, a, ind, max, comparator, elem_exchanger)           \
  {                                                                                                \
    ...
    do {                                                                                           \
      ...
      _r_ = _l_ + 1;                                                                               \
      if (_l_ < (max)) {                                                                           \
        if (comparator(a, _m_, _l_) < 0)                                                           \
          _m_ = _l_;                                                                               \
        if (_r_ < (max)) {                                                                         \
          if (comparator(a, _m_, _r_) < 0)                                                         \
            _m_ = _r_;                                                                             \
        }                                                                                          \
      }                                                                                            \
      if (_m_ != _i_) {                                                                            \
...
#define SGLIB_ARRAY_QUICK_SORT(type, a, max, comparator, elem_exchanger)                           \
  {                                                                                                \
    ...
    /*   type  _tmp_;\ Commented out by Manodeep Sinha, 6th April. The continuing slash is         \
     * important */                                                                                \
    _startStack_[0] = 0;                                                                           \
    _endStack_[0] = (max);                                                                         \
    _stacki_ = 1;                                                                                  \
...
#define SGLIB_ARRAY_BINARY_SEARCH(type, a, start_index, end_index, key, comparator, found,         \
                                  result_index)                                                    \
  {                                                                                                \
    int64_t _kk_, _cc_, _ii_, _jj_, _ff_;                                                          \
    _ii_ = (start_index);                                                                          \
    _jj_ = (end_index);                                                                            \
    _ff_ = 0;                                                                                      \
...
#define SGLIB_QUEUE_INIT(type, a, i, j)                                                            \
  {                                                                                                \
    i = j = 0;                                                                                     \
  }
...
#define SGLIB_HEAP_INIT(type, a, i)                                                                \
  {                                                                                                \
    i = 0;                                                                                         \
  }
...
#define SGLIB_HEAP_ADD_NEXT(type, a, i, dim, comparator, elem_exchanger)                           \
  {                                                                                                \
    int64_t _i_;                                                                                   \
    if (SGLIB_HEAP_IS_FULL(type, a, i, dim))                                                       \
      assert(0 && "the heap is full");                                                             \
    _i_ = (i)++;                                                                                   \
...
#define SGLIB_HEAP_DELETE_FIRST(type, a, i, dim, comparator, elem_exchanger)                       \
  {                                                                                                \
    if (SGLIB_HEAP_IS_EMPTY(type, a, i))                                                           \
      assert(0 && "the heap is empty");                                                            \
    (i)--;                                                                                         \
    a[0] = a[i];                                                                                   \
...
#define SGLIB_HASH_TAB_ADD_IF_NOT_MEMBER(type, table, dim, elem, hash_function, comparator,        \
  ...
  {                                                                                                \
    ...
    if (_elem_ == NULL) {                                                                          \
      if ((table)[_pos_] != NULL)                                                                  \
        assert(0 && "the hash table is full");                                                     \
      (table)[_pos_] = (elem);                                                                     \
    }                                                                                              \
  }
...
#define SGLIB_LIST_DELETE(type, list, elem, next)                                                  \
  {                                                                                                \
    ...
    for (_p_ = &(list); *_p_ != NULL && *_p_ != (elem); _p_ = &(*_p_)->next)                       \
      ;                                                                                            \
    assert(*_p_ != NULL &&                                                                         \
           "element is not member of the container, use DELETE_IF_MEMBER instead" != NULL);        \
    *_p_ = (*_p_)->next;                                                                           \
  }
    ...
    for (_n_ = 1; _contFlag_; _n_ = _n_ + _n_) {                                                   \
      ...
      while (_todo_ != NULL) {                                                                     \
        ...
        if (_a_ != NULL)                                                                           \
          ...
          *_restail_ = _b_;                                                                        \
        while (*_restail_ != NULL)                                                                 \
          _restail_ = &((*_restail_)->next);                                                       \
        _contFlag_ = 1;                                                                            \
      }                                                                                            \
    }                                                                                              \
    (list) = _r_;                                                                                  \
...
#define SGLIB_SORTED_LIST_IS_MEMBER(type, list, elem, comparator, next, result)                    \
  {                                                                                                \
    ...
    for (_p_ = (list); _p_ != NULL && comparator(_p_, (elem)) < 0; _p_ = _p_->next)                \
      ;                                                                                            \
    while (_p_ != NULL && _p_ != (elem) && comparator(_p_, (elem)) == 0)                           \
      _p_ = _p_->next;                                                                             \
    (result) = (_p_ == (elem));                                                                    \
  }

#define SGLIB_SORTED_LIST_FIND_MEMBER_OR_PLACE(type, list, elem, comparator, next,                 \
                                               comparator_result, member_ptr)                      \
  {                                                                                                \
    (comparator_result) = -1;                                                                      \
    for ((member_ptr) = &(list);                                                                   \
...
#define SGLIB___DL_LIST_GENERIC_ADD_IF_NOT_MEMBER(type, list, elem, comparator, previous, next,    \
                                                  member, the_add_operation)                       \
  {                                                                                                \
    type *_dlp_;                                                                                   \
    for (_dlp_ = (list); _dlp_ != NULL && comparator(_dlp_, (elem)) != 0; _dlp_ = _dlp_->previous) \
      ;                                                                                            \
    if (_dlp_ == NULL && (list) != NULL) {                                                         \
      for (_dlp_ = (list)->next; _dlp_ != NULL && comparator(_dlp_, (elem)) != 0;                  \
           _dlp_ = _dlp_->next)                                                                    \
        ;                                                                                          \
    }                                                                                              \
    (member) = _dlp_;                                                                              \
...
#define SGLIB_DL_LIST_ADD_BEFORE_IF_NOT_MEMBER(type, list, elem, comparator, previous, next,       \
                                               member)                                             \
  {                                                                                                \
    SGLIB___DL_LIST_GENERIC_ADD_IF_NOT_MEMBER(type, list, elem, comparator, previous, next,        \
                                              member, SGLIB_DL_LIST_ADD_BEFORE);                   \
  }
  ...
  {                                                                                                \
    ...
    while (_cn_ != NULL) {                                                                         \
      ...
      while (_cn_ != NULL) {                                                                       \
        ...
        _pathi_++;                                                                                 \
        if (_pathi_ >= SGLIB_MAX_TREE_DEEP)                                                        \
          assert(0 && "the binary_tree is too deep");                                              \
      }                                                                                            \
      do {                                                                                         \
        _pathi_--;                                                                                 \
...
#define SGLIB_DEFINE_HEAP_PROTOTYPES(heap_type, elem_type, afield, ifield, dim, comparator,        \
                                     elem_exchanger)                                               \
...
#define SGLIB_DEFINE_HEAP_FUNCTIONS(heap_type, elem_type, afield, ifield, dim, comparator,         \
                                    elem_exchanger)                                                \
...
#define SGLIB_DEFINE_HASHED_TABLE_PROTOTYPES(type, dim, hash_function, comparator)                 \
  ...
  extern type *sglib_hashed_##type##_it_init(struct sglib_hashed_##type##_iterator *it,            \
                                             type *table[dim]);                                    \
  extern type *sglib_hashed_##type##_it_init_on_equal(                                             \
      struct sglib_hashed_##type##_iterator *it, type *table[dim],                                 \
...
#define SGLIB_DEFINE_HASHED_TABLE_FUNCTIONS(type, dim, hash_function, comparator)                  \
  ...
  void sglib_hashed_##type##_init(type *table[dim]) { SGLIB_HASH_TAB_INIT(type, table, dim); }     \
  ...
  type *sglib_hashed_##type##_it_init_on_equal(                                                    \
      struct sglib_hashed_##type##_iterator *it, type *table[dim],                                 \
      int (*subcomparator)(type *, type *), type *equalto) {                                       \
    int i;                                                                                         \
    it->table = table;                                                                             \
  ...
  type *sglib_hashed_##type##_it_init(struct sglib_hashed_##type##_iterator *it,                   \
                                      type *table[dim]) {                                          \
...
#define SGLIB_DEFINE_HASHED_CONTAINER_FUNCTIONS(type, dim, hash_function)                          \
  ...
  type *sglib_hashed_##type##_it_init_on_equal(                                                    \
    ...
    it->subcomparator = subcomparator;                                                             \
    it->equalto = equalto;                                                                         \
    e = sglib_##type##_it_init_on_equal(&it->containerIt, table[it->currentIndex],                 \
                                        it->subcomparator, it->equalto);                           \
    if (e == NULL)                                                                                 \
      e = sglib_hashed_##type##_it_next(it);                                                       \
    return (e);                                                                                    \
  }                                                                                                \
  type *sglib_hashed_##type##_it_init(struct sglib_hashed_##type##_iterator *it,                   \
                                      type *table[dim]) {                                          \
  ...
  type *sglib_hashed_##type##_it_next(struct sglib_hashed_##type##_iterator *it) {                 \
    ...
    while (e == NULL && (++(it->currentIndex)) < (dim)) {                                          \
      e = sglib_##type##_it_init_on_equal(&it->containerIt, it->table[it->currentIndex],           \
                                          it->subcomparator, it->equalto);                         \
    }                                                                                              \
    return (e);                                                                                    \
  }
...
#define SGLIB_DEFINE_LIST_FUNCTIONS(type, comparator, next)                                        \
  ...
  void sglib_##type##_add(type **list, type *elem) { SGLIB_LIST_ADD(type, *list, elem, next); }    \
  ...
  void sglib_##type##_sort(type **list) { SGLIB_LIST_SORT(type, *list, comparator, next); }        \
...
#define SGLIB_DEFINE_DL_LIST_FUNCTIONS(type, comparator, previous, next)                           \
  ...
  int sglib_##type##_add_before_if_not_member(type **list, type *elem, type **member) {            \
    SGLIB_DL_LIST_ADD_BEFORE_IF_NOT_MEMBER(type, *list, elem, comparator, previous, next,          \
                                           *member);                                               \
    return (*member == NULL);                                                                      \
  }                                                                                                \
  void sglib_##type##_concat(type **first, type *second) {                                         \
  ...
  void sglib_##type##_reverse(type **list) { SGLIB_DL_LIST_REVERSE(type, *list, previous, next); } \
                                                                                                   \
  type *sglib_##type##_it_init_on_equal(struct sglib_##type##_iterator *it, type *list,            \
                                        int (*subcomparator)(type *, type *), type *equalto) {     \
    it->subcomparator = subcomparator;                                                             \
      ...
      if (SGLIB___GET_VALUE(b->bits) == RED) {                                                     \
        if (br == NULL) {                                                                          \
          *tree = b;                                                                               \
          ...
          cl = c->leftt;                                                                           \
          cr = c->rightt;                                                                          \
          if ((cl == NULL || SGLIB___GET_VALUE(cl->bits) == BLACK) &&                              \
              (cr == NULL || SGLIB___GET_VALUE(cr->bits) == BLACK)) {                              \
            *tree = b;                                                                             \
            b->rightt = a;                                                                         \
            SGLIB___SET_VALUE(b->bits, BLACK);                                                     \
            a->leftt = c;                                                                          \
        ...
        if ((bl == NULL || SGLIB___GET_VALUE(bl->bits) == BLACK) &&                                \
            (br == NULL || SGLIB___GET_VALUE(br->bits) == BLACK)) {                                \
...
#define SGLIB_DEFINE_RBTREE_FUNCTIONS_GENERAL(type, left, right, bits, comparator, RED, BLACK)     \
    ...
    if (t == NULL) {                                                                               \
      ...
      *tree = elem;                                                                                \
      ...
      if (cmp < 0 || (cmp == 0 && elem < t)) {                                                     \
        ...
        if (SGLIB___GET_VALUE(t->bits) == BLACK)                                                   \
          sglib___##type##_fix_left_insertion_discrepancy(tree);                                   \
      } else {                                                                                     \
        sglib___##type##_add_recursive(&t->right, elem);                                           \
        if (SGLIB___GET_VALUE(t->bits) == BLACK)                                                   \
          sglib___##type##_fix_right_insertion_discrepancy(tree);                                  \
      }                                                                                            \
    }                                                                                              \
  }                                                                                                \
                                                                                                   \
  static int sglib___##type##_delete_rightmost_leaf(type **tree, type **theLeaf) {                 \
    ...
    if (t->right == NULL) {                                                                        \
      *theLeaf = t;                                                                                \
      if (t->left != NULL) {                                                                       \
        if (SGLIB___GET_VALUE(t->bits) == BLACK && SGLIB___GET_VALUE(t->left->bits) == BLACK)      \
          res = 1;                                                                                 \
  ...
  int sglib___##type##_delete_recursive(type **tree, type *elem) {                                 \
    ...
    if (t == NULL) {                                                                               \
      ...
      if (cmp < 0 || (cmp == 0 && elem < t)) {                                                     \
        ...
        assert(elem == t &&                                                                        \
               "Deleting an element which is non member of the tree, use 'delete_if_member'" !=    \
                   NULL);                                                                          \
        if (t->left == NULL) {                                                                     \
          if (t->right == NULL) {                                                                  \
            /* a leaf, delete, it; */                                                              \
            *tree = NULL;                                                                          \
            ...
            if (SGLIB___GET_VALUE(t->bits) == 0 && SGLIB___GET_VALUE(t->right->bits) == 0)         \
              res = 1;                                                                             \
  ...
  type *sglib__##type##_it_init(struct sglib_##type##_iterator *it, type *tree, int order,         \
                                int (*subcomparator)(type *, type *), type *equalto) {             \
    type *t;                                                                                       \
    assert(it != NULL);                                                                            \
    it->order = order;                                                                             \
  ...
  type *sglib_##type##_it_init_on_equal(struct sglib_##type##_iterator *it, type *tree,            \
                                        int (*subcomparator)(type *, type *), type *equalto) {     \
    ...
    if (t == NULL) {                                                                               \
      if (*pathdeep < 0)                                                                           \
        *pathdeep = cdeep;                                                                         \
        ...
        assert(*pathdeep == cdeep);                                                                \
    } else {                                                                                       \
      if (t->left != NULL)                                                                         \
        assert(comparator(t->left, t) <= 0);                                                       \
      if (t->right != NULL)                                                                        \
        assert(comparator(t, t->right) <= 0);                                                      \
...
#define SGLIB___SET_VALUE(x, value)                                                                \
  {                                                                                                \
    (x) = (value);                                                                                 \
  }

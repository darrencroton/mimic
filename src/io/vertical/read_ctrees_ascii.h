#ifndef IO_VERTICAL_READ_CTREES_ASCII_H
#define IO_VERTICAL_READ_CTREES_ASCII_H

/**
 * @file    vertical/read_ctrees_ascii.h
 ...
 * registered VerticalReader). The ASCII-specific convention transform below is
...
#include "vertical/ctrees/ctrees_compat.h" /* struct halo_data */
#include "vertical/ctrees/ctrees_utils.h"  /* struct additional_info */
#include "vertical/read_ctrees_common.h"   /* apply_ctrees_value_conventions, bridge */
...
#endif /* IO_VERTICAL_READ_CTREES_ASCII_H */

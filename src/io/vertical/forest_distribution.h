#ifndef IO_VERTICAL_FOREST_DISTRIBUTION_H
#define IO_VERTICAL_FOREST_DISTRIBUTION_H

/**
 * @file    vertical/forest_distribution.h
 * @brief   Forest load-balancing schemes for forest-oriented vertical readers.
 *
...
#endif /* IO_VERTICAL_FOREST_DISTRIBUTION_H */

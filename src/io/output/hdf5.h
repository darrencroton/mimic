...
extern void open_hdf5_output_file(int filenr);
extern void save_halos_hdf5(int filenr, int tree);
extern void flush_hdf5_buffers(int filenr);
extern void write_hdf5_halo_batch(struct HaloOutput *halo_batch, int num_halos, int n, int filenr);

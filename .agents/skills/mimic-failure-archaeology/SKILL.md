...
| 9 | fix_flybys z=0 divergence (`b727fd36`, reversed) | **A reversed decision, and the reason matters.** Accepted 2026-08 as a ~10–25% Type-0 divergence measured on micro-Uchuu; refuted 2026-09-09 on Shin-Uchuu, where percolating forests put 33% of the z=0 population in one bogus FoF group. Deleted from the C reader and converter, snapshot format bumped to `format_version = 2` (`SHIN-UCHUU-FLYBY-DEFECT-ADDENDUM.md`). The transferable lesson: "accepted at the scale we tested" is not "accepted" |

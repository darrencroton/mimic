...
| 9 | fix_flybys z=0 divergence (`b727fd36`) | **A reversed decision, and the reason matters.** Accepted 2026-08 as a ~10–25% Type-0 divergence measured on micro-Uchuu; refuted 2026-09-09 on Shin-Uchuu, where percolating forests put 33% of the z=0 population in one bogus FoF group. Being deleted (`SHIN-UCHUU-FLYBY-DEFECT-ADDENDUM.md`). The transferable lesson: "accepted at the scale we tested" is not "accepted" |

...
| `MIMIC-DUAL-DRIVER-PLAN.md` | Partially active | Architecture and phased migration for tree-ordered and snapshot-ordered drivers, plus a physics-only embedded engine | **Phases 1–3 (core modularisation): now, as v1.0 work.** Phases 4–7 (snapshot reader and driver): after v1.0 is tagged and its baseline refreshed |

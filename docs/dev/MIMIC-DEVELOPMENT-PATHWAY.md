...
**Date:** 2026-07-02 · **last revised 2026-08-29** — became the declared entry point when the root `HANDOFF.md` was retired on 2026-08-28; Step 1 restructured around `SHIN-UCHUU-CONVERSION-PLAN.md` → "The Production Execution Sequence", and the converter scale pass added to Completed Work and to the archive list.
...
> ### ► NEXT TASK: the Shin-Uchuu **production run** — P1–P3 are done and measured; start at step P3b
> **This file is the entry point.** The operational sequence lives in [`SHIN-UCHUU-CONVERSION-PLAN.md`](SHIN-UCHUU-CONVERSION-PLAN.md) → **"The Production Execution Sequence"**: **P1–P3 ran to completion 2026-08-29 to 2026-09-03** (see that section's "Production run complete" note for the measured totals — 22,503,649,037 halos, 2.0 TB emitted, `unique_galaxy_id_multiplier: 20000000000` set and committed at `5506ef88`). Remaining: **P3b** (re-point `simulations/shin-uchuu/snapshots` at the production dataset — not yet done) through **P9** (archive the converted trees), then **F1** (`POST-PHASE-5-JOINT-REVIEW.md` §6 item 10) and **F2** (merge to `main`). That section carries every binding constraint with its code evidence.
>
...
| **1.5** | **Production run + science checks** — `sage16` end to end, then HMF and GSMF at z = 0, 1, 2 | **LIVE.** Steps **P3b–P9**, starting with re-pointing `simulations/shin-uchuu/snapshots` at the production dataset (not yet done). The goal the whole snapshot pathway exists to reach |

...
- **Property Metadata** (`src/core/halo_properties.yaml`, `src/modules/galaxy_properties.yaml`): Halo and galaxy properties auto-generate C structs, accessors, output code, and Python dtypes.

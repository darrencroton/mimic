...
def test_hdf5_baseline_comparison():
    ...
    # Tracked baselines under tests/data/ are regenerated whenever a
    # schema-affecting change lands, so they carry the current format
    # version; this expectation moves with hdf5_format_version.

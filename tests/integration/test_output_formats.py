...
def test_hdf5_baseline_comparison():
    ...
    # Tracked baselines under tests/data/ predate Slice 8 and are not
    # regenerated by it, so they still carry the pre-widening format version.
    assert_hdf5_schema_layout(baseline_file, expected_format_version="1.1")
    assert_hdf5_schema_layout(baseline_master_file, expected_format_version="1.1")

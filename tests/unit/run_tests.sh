...
CORE_SRCS="${SRC_DIR}/core/allvars.c ${SRC_DIR}/core/read_parameter_file.c ${SRC_DIR}/core/init.c ${SRC_DIR}/core/virial.c ${SRC_DIR}/core/inheritance.c ${SRC_DIR}/core/output_buffer.c"

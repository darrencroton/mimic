...
CORE_SRCS="${SRC_DIR}/core/allvars.c ${SRC_DIR}/core/read_parameter_file.c ${SRC_DIR}/core/init.c ${SRC_DIR}/core/tree_driver.c ${SRC_DIR}/core/snapshot_driver.c ${SRC_DIR}/core/halo_evolution.c ${SRC_DIR}/core/virial.c ${SRC_DIR}/core/timestep.c ${SRC_DIR}/core/inheritance.c ${SRC_DIR}/core/output_buffer.c ${SRC_DIR}/core/galaxy_pool.c"

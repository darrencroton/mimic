...
CORE_SRCS="${SRC_DIR}/core/allvars.c ${SRC_DIR}/core/read_parameter_file.c ${SRC_DIR}/core/init.c ${SRC_DIR}/core/vertical_driver.c ${SRC_DIR}/core/horizontal_driver.c ${SRC_DIR}/core/halo_evolution.c ${SRC_DIR}/core/virial.c ${SRC_DIR}/core/timestep.c ${SRC_DIR}/core/inheritance.c ${SRC_DIR}/core/output_buffer.c ${SRC_DIR}/core/galaxy_pool.c"
...
for src in $ALL_SRCS; do
    ...
    if [ "$HDF5_AVAILABLE" = "1" ]; then
        case "$src" in
            "${SRC_DIR}/io/vertical/registry.c"|\
            "${SRC_DIR}/io/vertical/hdf5.c"|\
            "${SRC_DIR}/io/vertical/read_ctrees_hdf5.c"|\
            "${SRC_DIR}/io/horizontal/registry.c"|\
            "${SRC_DIR}/io/horizontal/read_horizontal_hdf5.c"|\

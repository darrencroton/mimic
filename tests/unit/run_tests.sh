...
IO_SRCS="${SRC_DIR}/io/tree/interface.c ${SRC_DIR}/io/tree/binary.c ${SRC_DIR}/io/tree/registry.c ${SRC_DIR}/io/tree/read_ctrees_ascii.c ${SRC_DIR}/io/tree/ctrees/ctrees_utils.c ${SRC_DIR}/io/tree/ctrees/forest_utils.c ${SRC_DIR}/io/output/util.c ${SRC_DIR}/io/output/binary.c"
...
for src in $ALL_SRCS; do
    ...
    if ! $CC $CFLAGS -c "$src" -o "$obj" >> "$SHARED_COMPILE_LOG" 2>&1; then

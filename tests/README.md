...
│   └── output/                # Test outputs (baseline/, binary/, hdf5/)
...
- `baseline/` - Known-good outputs (committed, used for regression)
- `binary/` - Generated binary outputs (not in git)
- `hdf5/` - Generated HDF5 outputs (not in git)

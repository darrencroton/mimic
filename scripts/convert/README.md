...
# fix_upid equivalent (reference semantics, D12)
...
| `fixups.py`         | Phase 3 steps 1–5: a_list adjacency validation; spin `J/Mvir` and Len conventions; `fix_upid` reference equivalent |

...
**Status:** phases 0–2 and the Phase 3 fix-up stage implemented (scatter, sort/index, fixups — plan Slices 2–5). Links/ranks/identity, HDF5 emission, validation, and the micro-Uchuu cross-check land with later slices.

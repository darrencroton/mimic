#!/usr/bin/env python3
"""Create the tiny mini-Uchuu L-Halo binary fixture used by integration tests."""
...
DATA_DIR = ROOT / "data"
FIXTURE = DATA_DIR / "Uchuu400_test_lhalo_binary.0"
...
def fixture_halos() -> np.recarray:
    ...
    halos.MostBoundID = [940001, 940002, 940003, 940004, 940005, 940006]
